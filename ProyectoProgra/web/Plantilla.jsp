    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-md navbar-dark bg-dark">            
                <a class="text-white navbar-brand" href="ControllerUsuario?accion=vistaN">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav mr-auto menu">
                        <li style="float: left;" title="Administrar roles" class="nav-item">
                            <a class="nav-link active" href="ControllerRol?accion=vistaN">Roles</a>                            
                        </li>
                        <li style="float: left;" title="Administrar roles" class="nav-item">
                            <a class="nav-link active" href="ControllerModulo?accion=vistaN">Modulo</a>
                        </li>
                        <li style="float: left;" title="Administrar roles" class="nav-item">
